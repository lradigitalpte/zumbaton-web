      ...
      <div className="container px-3 sm:px-4 w-full">
        ...
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 mb-8 sm:mb-12">
          ...
          >
            ...
            <div className="bg-green-50 dark:bg-green-600/10 border-2 border-green-300 dark:border-green-600/30 rounded-xl sm:rounded-2xl p-4 sm:p-5 border-l-4 border-l-green-600 dark:border-l-green-500">
