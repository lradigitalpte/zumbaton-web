        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-sm leading-relaxed">
              Experience the joy of dance fitness. Our certified instructors bring 
              energy, passion, and results to every class. Join our community today!
            </p>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-lg bg-gray-800/50 hover:bg-green-600 flex items-center justify-center text-gray-400 hover:text-white transition-all duration-300 hover:scale-110"
          ...
          {/* Classes Links */}
          <div>
            <h4 className="text-white font-semibold mb-5 text-lg">Classes</h4>
            <ul className="space-y-3">
              {footerLinks.classes.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-gray-400 hover:text-green-500 transition-colors duration-300 flex items-center gap-2 group"
                  >
            ...
            <form className="space-y-3">
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all"
                />
              </div>
              <button
                type="submit"
                className="w-full py-3 bg-green-600 hover:bg-green-500 text-white font-semibold rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-green-500/25"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="container py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-6 text-sm">
              <a href="tel:+18005559862" className="flex items-center gap-2 text-gray-400 hover:text-green-500 transition-colors">
