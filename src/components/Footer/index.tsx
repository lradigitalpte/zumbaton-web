      ...
      <div className="container px-3 sm:px-4 py-10 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 md:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-xs sm:text-sm md:text-base text-gray-400 mb-4 sm:mb-6 max-w-sm leading-relaxed">
        ...
        <div className="container px-3 sm:px-4 py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 sm:gap-6 text-xs sm:text-sm">
              <a href="tel:+18005559862" className="flex items-center gap-1.5 sm:gap-2 text-gray-400 hover:text-green-500 transition-colors">
                <svg className="w-3.5 sm:w-4 h-3.5 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="hidden sm:inline">+1 (800) 555-ZUMBA</span>
                <span className="sm:hidden">+1 (800)</span>
              </a>
              <a href="mailto:info@zumbathon.com" className="flex items-center gap-1.5 sm:gap-2 text-gray-400 hover:text-green-500 transition-colors">
                <svg className="w-3.5 sm:w-4 h-3.5 sm:h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="hidden sm:inline">info@zumbathon.com</span>
            ...
            <div className="flex items-center gap-2 text-gray-500 text-xs sm:text-sm">
              ...
              <span className="hidden sm:inline">Open 7 days a week</span>
              <span className="sm:hidden">Open 7 days</span>
            </div>
          </div>
        </div>
      </div>
