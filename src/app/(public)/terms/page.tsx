...
export const metadata: Metadata = {
  title: "Terms of Service | One Step Fitness",
  description: "One Step Fitness terms and conditions for membership, bookings, safety, and liability.",
};
      ...
      <section className="py-16 md:py-20 lg:py-28 bg-white dark:bg-gray-900">
        <div className="container px-3 sm:px-4 max-w-3xl mx-auto">
          <div className="prose prose-lg dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 space-y-6">
            ...
            <p>
              You may cancel or terminate your membership for medical reasons if a doctor provides certification that your participation in One Step Fitness step aerobics activities would impair your health. In the event of death or disability, liability for membership terminates as at the date of death or disability.
            </p>
            <p>
              If our facilities become temporarily unavailable (e.g. fire, flood, loss of lease), we may freeze your membership for the period they were unavailable. One Step Fitness management retains the sole and absolute right to cancel, freeze, and/or suspend the membership of any person for any reason. If cancellation or suspension is due to a breach of these Terms, our Membership Policies, or Safety Notices, or due to damage caused by you, the balance of your financial obligations under your agreement shall become immediately due and payable.
            </p>
            ...
            <p>
              You understand and acknowledge the risk of injury arising from One Step Fitness activities. You willingly assume all risks associated with the exercise choreography. One Step Fitness is independently owned and operated. You release, indemnify, and hold harmless One Step Fitness&apos;s employees, owners, and partners in respect of any and all injury, disability, death, loss, or damage to person and/or property that may arise from or in connection with your use of the studio or otherwise related to your membership. This release is intended to be as broad and inclusive as permitted by applicable law. If any portion is held invalid, the balance remains in full force and effect.
            </p>
            ...
            <p>
              You must wear covered shoes (excluding boots) for all One Step Fitness sessions, whether indoors or outdoors. We highly recommend active sportswear and bringing bottled water for hydration and water breaks.
            </p>

            <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">8. Media Consent</h2>
            <p>
              By participating in One Step Fitness activities, you consent to participate in the production of media (including image, likeness, voice, performance, and visual works) that may be personally identifiable and published on social media or elsewhere. You agree to such use unless you inform us otherwise in writing.
            </p>

            <h2 className="text-xl font-bold text-gray-900 dark:text-white mt-8">9. Conduct</h2>
            <p>
              We expect all participants to behave respectfully towards instructors, staff, and other members. One Step Fitness reserves the right to refuse service or revoke membership in case of misconduct or breach of these Terms.
            </p>
