...
export default function RegistrationFormPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.bloodGroup.trim()) {
      setError('Please enter your blood group')
      return
    }
        ...
        <div className="bg-white shadow-lg rounded-lg overflow-hidden">
          <form onSubmit={handleSubmit} className="p-8">
            ...
            <section className="mb-8 p-6 bg-gray-50 rounded-lg">
              ...
              <div className="max-h-96 overflow-y-auto p-4 bg-white rounded border border-gray-300 text-sm space-y-4 mb-6">
                <p className="font-bold">MEMBER ASSUMPTION OF RISK AND RELEASE</p>
                <p>
                  I hereby understand and acknowledge the risk of injury arising from and/or in connection with ZUMBATON's activities. 
                  I willingly assume all the risks associated with the exercise choreographed. I understand that ZUMBATON is independently 
                  owned and operated. I HEREBY RELEASE, INDEMNIFY, AND HOLD HARMLESS to ZUMBATON's employees, owners, and partners WITH 
                  RESPECT TO ANY AND ALL INJURY, DISABILITY, DEATH, LOSS OR DAMAGE to person and/or property that may arise out of or in 
                  connection with my use of the studio, or otherwise related to my subscription.
                </p>

                <p className="font-bold">1. MEMBERSHIP</p>
                <p>
                  1.1. Membership is personal to the member and is non-transferable and non-refundable. You may not loan or sell your 
                  membership or otherwise permit it to be used by any third party.
                </p>

                <p className="font-bold">2. CANCELLATION AND TERMINATION</p>
                <p>
                  2.1. Cancellation of class after booking should be made at least 24 hours before the class date. Booked class with a 
                  "NO SHOW" will be forfeited.
                </p>

                <p className="font-bold">3. PHYSICAL CONDITION</p>
                <p>
                  3.1. You hereby warrant that you are in good physical and mental condition and that you know of no medical reason why 
                  you are not capable of engaging in active or passive exercise and that such exercise would not be detrimental to your 
                  health, safety, comfort, or physical condition.
                </p>

                <p className="font-bold">4. ATTIRE & SAFETY</p>
                <p>
                  4.1. You are required to wear covered shoes excluding boots for all ZUMBATON sessions regardless indoors or outdoors.
                </p>

                <p>For full terms and conditions, please refer to the document provided via email.</p>
              </div>
